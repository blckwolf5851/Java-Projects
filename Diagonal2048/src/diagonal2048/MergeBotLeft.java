...
/***********
 * A main program merge the grid to bottom left
 * 
 * @author Sherry Yuan
 * @version 1.0 (2018/6/2)
 * ****************
 */
public class MergeBotLeft {
	/*
	public static void main(String[] arg) {
		int[][] grid = {{4,2,2,4,4},{4,0,2,4,4},{0,0,4,4,4},{4,4,4,4,2}, {4,2,4,4,2}};
		...
		System.out.println();
		int[][] mergedgrid = mergeBotLeft(grid,grid.length, grid[0].length);
	...
	*/
	/**
	 * mergeGrid to bottom Left
	 * @param int[][], 2D array to be modified
	 * @return int[][], resulting 2D array
	 */
	public static int[][] mergeBotLeft (int[][] grid, int totalRow, int totalCol) {
